...
- `apps/exercise-mobile` - Expo shell reusing the identical runtime on phones: skeleton rendered via pure-TS forward kinematics (`worldJointPositions`) projected into react-native-svg, planned workouts, hysteresis rep counting, form warnings. Runs in Expo Go; Metro-bundle verified in CI-style export.
